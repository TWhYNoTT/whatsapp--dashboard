        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForwardToHuman = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasOptedIn = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Royal = table.Column<int>(type: "int", nullable: false),
                    Grnata = table.Column<int>(type: "int", nullable: false),
                    Aswak = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InvoiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SecondaryInvoiceID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    AgreedDuration = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    MaintenanceCostType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmployeeName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmployeeNameR = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Branch = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateSid = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DeliveredMessages = table.Column<int>(type: "int", nullable: false),
                    ReadMessages = table.Column<int>(type: "int", nullable: false),
                    FailedMessages = table.Column<int>(type: "int", nullable: false),
                    Responses = table.Column<int>(type: "int", nullable: false),
                    Variable1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Variable2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Variable3 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAutomatedResponse = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisableChatbot = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConversationAssignments_AspNetUsers_AgentId",
                        column: x => x.AgentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CampaignRecipients_WhatsAppCampaigns_CampaignId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConversationAssignments_AgentId_IsActive",
                table: "ConversationAssignments",
                columns: new[] { "AgentId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_ConversationAssignments_ContactNumber_IsActive",
                table: "ConversationAssignments",
                columns: new[] { "ContactNumber", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_WhatsAppMessages_ContactNumber",
